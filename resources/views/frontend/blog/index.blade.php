...
<section class="page_banner text-center pt-150 pb-60">
  <div class="container decoration_wrap">
    <h1 class="page_title mb-15">Blog Grid with Sidebar</h1>
    <ul class="breadcrumb_nav unordered_list_center">
      <li><a href="{{ route('home') }}">Home</a></li>
      <li>Expovents Bolgs</li>
    </ul>
  </div>
</section>
      ...
      <div class="blog_responsive col-lg-8">
        <div class="blog_wrapper">
          <div class="row g-4">
            <div class="col-md-6">
              <div class="blog_item">
                <a class="item_image" href="blog-details/%5bid%5d"
                  ><img
                ...
                <div class="item_content">
                  <div class="flex_wrap">
                    <ul class="category_list unordered_list">
                      <li><a href="blog-details/%5bid%5d">UI/UX</a></li>
                    </ul>
                  ...
                  <h3 class="item_title">
                    <a href="blog-details/%5bid%5d"
                      >Event Security: Ensuring Safety and Peace of Mind</a
                    >
                  </h3>
                  <div class="header__btn">
                    <a class="blog_custome_btn" href="blog-details/%5bid%5d"
            ...
            <div class="col-md-6">
              <div class="blog_item">
                <a class="item_image" href="blog-details/%5bid%5d-2"
                  ><img
                    src="{{ URL::asset('build/media/blog-2.bbdee4b9.jpg') }}"
                    alt="Blog Image"
                    style="height: 100%; width: 100%"
                /></a>
                <div class="item_content">
                  <div class="flex_wrap">
                    <ul class="category_list unordered_list">
                      <li>
                        <a href="blog-details/%5bid%5d-2">App Developer</a>
                      </li>
                    </ul>
                    <span class="post_date"
                      ><span style="margin-right: 10px"
                  ...
                  <h3 class="item_title">
                    <a href="blog-details/%5bid%5d-2"
                      >The Ultimate Event Planning Guide to Execution</a
                    >
                  </h3>
                  <div class="header__btn">
                    <a class="blog_custome_btn" href="blog-details/%5bid%5d-2"
                      >Read More<i class="fa-regular fa-angle-right"></i
                    ></a>
                  </div>
                </div>
            ...
            <div class="col-md-6">
              <div class="blog_item">
                <a class="item_image" href="blog-details/%5bid%5d-3"
                  ><img
                    src="{{ URL::asset('build/media/blog-3.26bfd5ef.jpg') }}"
                    alt="Blog Image"
                    style="height: 100%; width: 100%"
                /></a>
                <div class="item_content">
                  <div class="flex_wrap">
                    <ul class="category_list unordered_list">
                      <li>
                        <a href="blog-details/%5bid%5d-3">Business</a>
                      </li>
                    </ul>
                    <span class="post_date"
                      ><span style="margin-right: 10px"
                  ...
                  <h3 class="item_title">
                    <a href="blog-details/%5bid%5d-3"
                      >Unleashing the Power of Event Management</a
                    >
                  </h3>
                  <div class="header__btn">
                    <a class="blog_custome_btn" href="blog-details/%5bid%5d-3"
                      >Read More<i class="fa-regular fa-angle-right"></i
                    ></a>
                  </div>
                </div>
            ...
            <div class="col-md-6">
              <div class="blog_item">
                <a class="item_image" href="blog-details/%5bid%5d-4"
                  ><img
                    src="{{ URL::asset('build/media/blog-4.6d9df855.jpg') }}"
                    alt="Blog Image"
                    style="height: 100%; width: 100%"
                /></a>
                <div class="item_content">
                  <div class="flex_wrap">
                    <ul class="category_list unordered_list">
                      <li>
                        <a href="blog-details/%5bid%5d-4">UI/UX</a>
                      </li>
                    </ul>
                    <span class="post_date"
                      ><span style="margin-right: 10px"
                  ...
                  <h3 class="item_title">
                    <a href="blog-details/%5bid%5d-4"
                      >Trends in Event Planning: What&#x27;s Hot and What&#x27;s
                      No ...</a
                    >
                  </h3>
                  <div class="header__btn">
                    <a class="blog_custome_btn" href="blog-details/%5bid%5d-4"
                      >Read More<i class="fa-regular fa-angle-right"></i
                    ></a>
                  </div>
                </div>
              ...
              <div class="blog_item">
                ...
                <div class="item_content">
                  <div class="flex_wrap">
                    <ul class="category_list unordered_list">
                      <li>
                        <a href="blog-details/%5bid%5d-5">App Developer</a>
                      </li>
                    </ul>
                    <span class="post_date"
                      ><span style="margin-right: 10px"
                  ...
                  <h3 class="item_title">
                    <a href="blog-details/%5bid%5d-5"
                      >Event Budgeting 101: How to Plan and Control Costs ...</a
                    >
                  </h3>
                  <div class="header__btn">
                    <a class="blog_custome_btn" href="blog-details/%5bid%5d-5"
                      >Read More<i class="fa-regular fa-angle-right"></i
                    ></a>
                  </div>
                </div>
            ...
            <div class="col-md-6">
              <div class="blog_item">
                <a class="item_image" href="blog-details/%5bid%5d-6"
                  ><img
                ...
                <div class="item_content">
                  <div class="flex_wrap">
                    <ul class="category_list unordered_list">
                      <li>
                        <a href="blog-details/%5bid%5d-6">Business</a>
                      </li>
                    </ul>
                    <span class="post_date"
                      ><span style="margin-right: 10px"
                  ...
                  <h3 class="item_title">
                    <a href="blog-details/%5bid%5d-6"
                      >Harnessing Technology for Successful Event Managem ...</a
                    >
                  </h3>
                  <div class="header__btn">
                    <a class="blog_custome_btn" href="blog-details/%5bid%5d-6"
                      >Read More<i class="fa-regular fa-angle-right"></i
                    ></a>
                  </div>
                </div>
            ...
            <div class="col-md-6">
              <div class="blog_item">
                <a class="item_image" href="blog-details/%5bid%5d-7"
                  ><img
                ...
                <div class="item_content">
                  <div class="flex_wrap">
                    <ul class="category_list unordered_list">
                      <li>
                        <a href="blog-details/%5bid%5d-7">UI/UX</a>
                      </li>
                    </ul>
                    <span class="post_date"
                      ><span style="margin-right: 10px"
                  ...
                  <h3 class="item_title">
                    <a href="blog-details/%5bid%5d-7"
                      >The Role of Social Media in Event Promotion and En ...</a
                    >
                  </h3>
                  <div class="header__btn">
                    <a class="blog_custome_btn" href="blog-details/%5bid%5d-7"
                      >Read More<i class="fa-regular fa-angle-right"></i
                    ></a>
                  </div>
                </div>
            ...
            <div class="col-md-6">
              <div class="blog_item">
                <a class="item_image" href="blog-details/%5bid%5d-8"
                  ><img
                    src="{{ URL::asset('build/media/blog-8.1944b8fd.jpg') }}"
                    alt="Blog Image"
                    style="height: 100%; width: 100%"
                /></a>
                <div class="item_content">
                  <div class="flex_wrap">
                    <ul class="category_list unordered_list">
                      <li>
                        <a href="blog-details/%5bid%5d-8">App Developer</a>
                      </li>
                    </ul>
                    <span class="post_date"
                      ><span style="margin-right: 10px"
                  ...
                  <h3 class="item_title">
                    <a href="blog-details/%5bid%5d-8"
                      >Event Security: Ensuring Safety and Peace of Mind</a
                    >
                  </h3>
                  <div class="header__btn">
                    <a class="blog_custome_btn" href="blog-details/%5bid%5d-8"
                      >Read More<i class="fa-regular fa-angle-right"></i
                    ></a>
                  </div>
                </div>
                ...
                <div class="recent_post_item">
                  ...
                  <div class="item_content">
                    <ul class="meta_list unordered_list">
                      <li><a href="404">App Developer</a></li>
