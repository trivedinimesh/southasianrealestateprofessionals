            ...
            <div class="col-md-4">
              <div class="blog_item ">
                <a class="item_image" href="{{ route('blog-detail') }}">
                  <img src="{{ URL::asset('build/media/blog-1.00bb18f1.jpg') }}" alt="Blog Image" style="height: 100%; width: 100%" />
                </a>
                <div class="item_content">
                  <h3 class="item_title">
                    <a class="text-black" href="{{ route('blog-detail') }}">Top Factors to Consider When Investing in Real Estate</a>
                  </h3>
                  <div class="flex_wrap">
                    <ul class="category_list unordered_list">
                      <li>
                        <a href="{{ route('blog-detail') }}">Real Estate</a>
                      </li>
                    </ul>
                    <span class="post_date text-black">
                      <span style="margin-right: 10px">
                  ...
                  <div class="header__btn">
                    <a class="blog_custome_btn" href="{{ route('blog-detail') }}">Read More <i class="fa-regular fa-angle-right"></i>
                    </a>
                  </div>
                </div>
              </div>
