...
<!-- Modal Structure -->
<!-- Modal -->
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="registerModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text__highlight" id="registerModal">Unlock Exclusive Benefits!</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <p>Enjoy discounted prices, access to members-only events, and so much more.</p>
        <p>Want to register now and take advantage of all the perks?</p>
      </div>
      <div class="modal-footer">
        <a href="{{route('membership')}}" class="btn btn-danger">Registration</a>
