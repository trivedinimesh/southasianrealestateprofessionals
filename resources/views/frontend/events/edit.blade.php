                                ...
                                <div class="create__input-wrapper row">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                                        ...
                                        <label for="formFile" class="input__field-textlabel">Add Image</label><br/>
                                            ...
                                            @if($event->image)
                                                <div class="mb-3">
                                                    <img src="{{ asset('images/events/' . $event->image) }}" alt="Event Image" class="img-event" width="200">
                                                </div>
                                            @endif
                                ...
                                <select class="tom-select-multiple w-full" name="features[]" multiple>
                                    ...
                                    <div class="col-xxl-3 col-xl-3 col-lg-3">
                                        <div class="singel__input-field mb-15">
                                            ...
                                            <input name="country" type="text" value="{{$event->country}}"/>
                                            @error('country')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-xxl-3 col-xl-3 col-lg-3">
                                        <div class="singel__input-field mb-15">
                                            ...
                                            <input name="state" type="text" value="{{$event->state}}" />
                                            @error('state')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-xxl-3 col-xl-3 col-lg-3">
                                        <div class="singel__input-field mb-15">
                                            ...
                                            <input name="pincode" type="text" value="{{$event->pincode}}"/>
                                            @error('pincode')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
