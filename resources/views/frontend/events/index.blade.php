                    ...
                    <div class="section__title-wrapper is-left mb-110">
                        ...
                        <h2 class="section__title">
                            ...
                            <span class="text__highlight">
                                Schedule<svg width="328" height="31" viewBox="0 0 328 31" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M2 29C110 8.62517 326 -19.8996 326 29" stroke="url(#paint0_linear_47_128)"
                                        stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <defs>
                                        <linearGradient id="paint0_linear_47_1281" x1="2.50784" y1="22.0412"
                                            x2="322.486" y2="65.0473" gradientUnits="userSpaceOnUse">
                                    ...
                                    <h2 class="accordion-header" id="headingOne">
                                        <span class="accordion-button" data-bs-toggle="collapse"
                                            ...
                                            <span class="accordion__heading">
                                                ...
                                                <span class="accordion__meta accordion-border"><span
                                                        class="accordion__meta-contet"><span
                                                            class="title">{{$event->title}}</span><span
                                                            class="info">{{$event->address}}, {{$event->city}},
                                        ...
                                        <div class="accordion-body">
                                            <div class="accordiong__inner">
                                                ...
                                                <div class="accordiong__meta">
                                                    <span class="info"><i class="fa-light fa-clock"></i>
                                                        {{ \Carbon\Carbon::parse($event->start_time)->format('g:i A') }}
                                                        - {{ \Carbon\Carbon::parse($event->end_time)->format('g:i A')
                                                        }}</span><span><i class="flaticon-calendar"></i>{{
                                                        \Carbon\Carbon::parse($event->date)->format('F d, Y')
                                                        }}</span><span><i
                                                            class="flaticon-placeholder-1"></i>{{$event->city}},
                                                        {{$event->state}}, {{$event->country}}</span>
                                                    <div class="header__btn">
                                                        <a class="blog_custome_btn"
                                                            href="{{route('event-detail', $event->id)}}">Read More<i
