        ...
        <tr>
            <td align="center">
                <table width="600px" cellpadding="0" cellspacing="0" style="background-color: #ffffff; padding: 20px; border-radius: 8px;">
                    ...
                    <tr>
                        <td style="text-align: center;">
                            <p style="font-size: 16px; color: #666666;">We are excited to offer you some amazing membership upgrades!</p>
                            <p style="font-size: 16px; color: #666666;">Check out our premium plans to enjoy additional benefits and features.</p>
                        </td>
                    </tr>
