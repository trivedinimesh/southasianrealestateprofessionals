                ...
                <table width="600px" cellpadding="0" cellspacing="0" style="background-color: #ffffff; padding: 20px; border-radius: 8px;">
                    ...
                    <tr>
                        <td style="text-align: center;">
                            <h1 style="font-size: 26px; color: #333333;">Subscription Successful!</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">
                            <p style="font-size: 16px; color: #666666;">Dear <strong>{{ $first_name }} {{ $last_name }}</strong>, you have successfully subscribed to the plan <strong>{{ $planName }}</strong>.</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding-top: 20px; text-align: center;">
                            <div style="background-color: #f9f9f9; border: 1px solid #dddddd; border-radius: 8px; padding: 20px; display: inline-block;">
                                <h2 style="font-size: 22px; color: #333333;">Your Subscription Details</h2>
