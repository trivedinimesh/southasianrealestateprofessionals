                ...
                <table width="600px" cellpadding="0" cellspacing="0" style="background-color: #ffffff; padding: 20px; border-radius: 8px;">
                    ...
                    <tr>
                        <td style="text-align: center; padding-bottom: 20px;">
                            <img src="./public/logosarep.png" alt="Your Company Logo" width="150px" style="border-radius: 8px;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="text-align: center;">
                            <h1 style="font-size: 26px; color: #333333;">Hello {{ $first_name }} {{ $last_name }},</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">
                            <p style="font-size: 16px; color: #666666;">This is a friendly reminder about your upcoming event:</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding-top: 20px; text-align: center;">
                            <div style="background-color: #f9f9f9; border: 1px solid #dddddd; border-radius: 8px; padding: 20px; display: inline-block;">
                                ...
                                <p style="font-size: 16px; color: #666666;">Date: {{ \Carbon\Carbon::parse($event_date)->format('F d, Y') }}</p>
                            </div>
                        </td>
                    </tr>
